  ...
  const newsItems = [
    {
      ...
      imageUrl: "./src/assets/Aether.jpg" // Replace with the actual path to your news images
    },
    {
      ...
      imageUrl: "./src/assets/preseason.jpg"
    },
    {
      ...
      imageUrl: "./src/assets/worlds.jpg"
    },
    {
  ...
  return (
    ...
    <Container style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      ...
      <Paper elevation={3} style={{ padding: '20px', margin: '40px 0' }}>
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={8}>
            ...
            <Button className='button_g' type="primary" href='champions'>Learn More</Button>
          </Grid>
        </Grid>
      </Paper>
      ...
      <Paper elevation={3} style={{ padding: '40px', margin: '40px 0', textAlign: 'center' }}>
        ...
        <Button className='button_g' type="primary" size="large" href='https://www.leagueoflegends.com'>Play Now</Button>
      </Paper>
    </Container>
  );
}
