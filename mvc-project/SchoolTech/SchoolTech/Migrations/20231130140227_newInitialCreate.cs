    ...
    public partial class newInitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GebruikerRolId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GebruikerId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    RolId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GebuikerRol", x => x.GebruikerRolId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KostprijsStudiebezoek = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ...
                    KostprijsVervoer = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
